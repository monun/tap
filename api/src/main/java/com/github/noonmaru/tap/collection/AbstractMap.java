...
abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    /**
     * Returns a shallow copy of this {@code MoxAbstractMap} instance: the keys
    ...
    public static class SimpleEntry<K, V>
        ...
        private static final long serialVersionUID = -4884152024723122574L;
    ...
    public static class SimpleImmutableEntry<K, V>
        ...
        private static final long serialVersionUID = 4049369466184589177L;
