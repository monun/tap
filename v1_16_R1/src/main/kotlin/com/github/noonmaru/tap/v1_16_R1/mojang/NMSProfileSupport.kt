...
class NMSProfileSupport : ProfileSupport {
    ...
    override fun getProfile(uniqueId: UUID): MojangProfile? {
        return userCache.getProfile(uniqueId)?.let { MojangProfile(it.id, it.name) }
    }
}